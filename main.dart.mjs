...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      AJ: x0 => x0.close(),
      AK: (x0,x1) => x0.createElement(x1),
      AL: (x0,x1) => { x0.width = x1 },
      AM: x0 => x0.length,
      ...
      CK: (x0,x1,x2) => x0.removeEventListener(x1,x2),
      CL: x0 => x0.width,
      CM: x0 => x0.target,
      ...
      DK: x0 => x0.remove(),
      DL: x0 => x0.rasterEndMilliseconds,
      ...
      EL: x0 => x0.rasterStartMilliseconds,
      EM: x0 => x0.click(),
      F: () => new Error().stack,
      ...
      GL: x0 => x0.canvasKitMaximumSurfaces,
      ...
      HK: (x0,x1,x2,x3) => x0.replaceState(x1,x2,x3),
      HL: x0 => x0.nextSibling,
      ...
      JK: x0 => x0.href,
      JL: x0 => x0.hostElement,
      JM: x0 => x0.sessionStorage,
      K: (exn) => {
      ...
      KK: () => new Array(),
      KL: x0 => x0.location,
      KM: (x0,x1,x2,x3) => x0.decrypt(x1,x2,x3),
      L: o => o === undefined,
      ...
      LK: (x0,x1) => new WebSocket(x0,x1),
      LL: (x0,x1) => x0.getModifierState(x1),
      LM: x0 => x0.subtle,
      M: o => String(o),
      ...
      OK: (o, t) => typeof o === t,
      OL: x0 => x0.ctrlKey,
      OM: (x0,x1,x2,x3,x4,x5,x6,x7) => x0.unwrapKey(x1,x2,x3,x4,x5,x6,x7),
      ...
      PK: (x0,x1,x2) => x0.close(x1,x2),
      PL: x0 => x0.isComposing,
      PM: (x0,x1,x2,x3,x4,x5) => x0.importKey(x1,x2,x3,x4,x5),
      ...
      QK: (x0,x1) => x0.close(x1),
      QL: x0 => x0.code,
      QM: (x0,x1,x2,x3) => x0.generateKey(x1,x2,x3),
      ...
      RK: x0 => x0.close(),
      RL: x0 => x0.repeat,
      RM: (x0,x1,x2,x3,x4) => x0.wrapKey(x1,x2,x3,x4),
      ...
      SM: (x0,x1,x2) => x0.exportKey(x1,x2),
      T: x0 => new Promise(x0),
      ...
      TK: x0 => x0.readyState,
      TL: x0 => x0.userAgent,
      TM: (x0,x1) => x0.getRandomValues(x1),
      ...
      UK: (x0,x1) => { x0.binaryType = x1 },
      UL: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      UM: (x0,x1,x2,x3) => x0.encrypt(x1,x2,x3),
      V: (constructor, args) => {
      ...
      bJ: (x0,x1,x2) => x0.addEventListener(x1,x2),
      ...
      eL: x0 => globalThis.URL.createObjectURL(x0),
      ...
      hK: x0 => x0.statusText,
      hL: (x0,x1,x2,x3,x4,x5) => x0.drawImage(x1,x2,x3,x4,x5),
      i: (l, r) => l === r,
      ...
      jJ: (x0,x1,x2) => x0.postMessage(x1,x2),
      jK: x0 => x0.status,
      jL: x0 => x0.width,
      k: o => o,
      ...
      tI: x0 => x0.name,
      tJ: (x0,x1) => { x0.display = x1 },
      tK: (x0,x1) => x0.removeItem(x1),
      ...
      uK: x0 => x0.localStorage,
      uL: (x0,x1) => { x0.oncancel = x1 },
      v: (a, i) => a.push(i),
      ...
      xI: x0 => x0.completed,
      xJ: x0 => x0.style,
      xK: (x0,x1) => x0.transferFromImageBitmap(x1),
      ...
      yI: x0 => x0.ready,
      yJ: (x0,x1) => { x0.title = x1 },
      yK: (x0,x1) => x0.getContext(x1),
      yL: x0 => x0.name,
