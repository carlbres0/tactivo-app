...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      EJ: x0 => x0.name,
      EK: x0 => x0.baseURI,
      EL: (x0,x1) => x0.getItem(x1),
      EM: (x0,x1) => { x0.onchange = x1 },
      F: () => new Error().stack,
      ...
      FL: (x0,x1) => x0.transferFromImageBitmap(x1),
      FM: x0 => x0.type,
      ...
      LL: x0 => x0.rasterEndMilliseconds,
      LM: x0 => x0.target,
      M: o => String(o),
      ...
      ML: x0 => x0.rasterStartMilliseconds,
      ...
      OK: x0 => x0.history,
      OL: x0 => x0.canvasKitMaximumSurfaces,
      OM: (x0,x1,x2) => x0.setAttribute(x1,x2),
      ...
      PK: x0 => x0.href,
      PL: x0 => x0.nextSibling,
      PM: (x0,x1) => { x0.accept = x1 },
      ...
      QJ: x0 => x0.duration,
      QK: x0 => x0.location,
      QL: (x0,x1) => x0.debug(x1),
      QM: (x0,x1) => { x0.multiple = x1 },
      ...
      SK: (x0,x1) => new WebSocket(x0,x1),
      SL: x0 => x0.location,
      SM: x0 => x0.sessionStorage,
      T: x0 => new Promise(x0),
      ...
      TJ: () => new FileReader(),
      TK: x0 => x0.reason,
      TL: (x0,x1) => x0.getModifierState(x1),
      TM: (x0,x1,x2,x3) => x0.decrypt(x1,x2,x3),
      ...
      XK: (x0,x1,x2) => x0.close(x1,x2),
      XL: x0 => x0.isComposing,
      XM: (x0,x1,x2,x3,x4,x5,x6,x7) => x0.unwrapKey(x1,x2,x3,x4,x5,x6,x7),
      Y: (o0, o1) => [o0, o1],
      YB: (t, s) => t.set(s),
      ...
      YK: (x0,x1) => x0.close(x1),
      YL: x0 => x0.code,
      YM: (x0,x1,x2,x3,x4,x5) => x0.importKey(x1,x2,x3,x4,x5),
      Z: (o0, o1, o2) => [o0, o1, o2],
      ...
      ZK: x0 => x0.close(),
      ZL: x0 => x0.repeat,
      ZM: (x0,x1,x2,x3) => x0.generateKey(x1,x2,x3),
      ...
      aM: (x0,x1,x2,x3,x4) => x0.wrapKey(x1,x2,x3,x4),
      b: (x0,x1,x2) => { x0[x1] = x2 },
      bB: o => {
        if (o === null || o === undefined) return 0;
      ...
      bK: x0 => x0.readyState,
      bL: x0 => x0.userAgent,
      bM: (x0,x1,x2) => x0.exportKey(x1,x2),
      c: o => o,
      ...
      cI: x0 => x0.style,
      cJ: x0 => x0.send(),
      cK: (x0,x1) => { x0.binaryType = x1 },
      cL: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      cM: (x0,x1) => x0.getRandomValues(x1),
      d: (o, p) => o[p],
      dB: o => {
        if (o === null || o === undefined) return 0;
      ...
      dI: (x0,x1) => { x0.src = x1 },
      dJ: x0 => x0.type,
      dK: x0 => new BroadcastChannel(x0),
      dL: (x0,x1) => x0.key(x1),
      dM: (x0,x1,x2,x3) => x0.encrypt(x1,x2,x3),
      e: () => globalThis,
      ...
      jL: x0 => globalThis.URL.revokeObjectURL(x0),
      jM: x0 => x0.body,
      k: o => o,
      ...
      lK: (x0,x1) => x0.get(x1),
      lL: (x0,x1,x2,x3) => x0.toBlob(x1,x2,x3),
      lM: x0 => x0.assetBase,
      m: () => globalThis.Math,
      ...
      mL: x0 => globalThis.URL.createObjectURL(x0),
      mM: x0 => x0.loader,
      ...
      oJ: x0 => x0.send(),
      oK: x0 => x0.name,
      oL: (x0,x1,x2,x3) => x0.drawImage(x1,x2,x3),
      p: b => !!b,
      ...
      pJ: x0 => x0.status,
      pK: x0 => x0.statusText,
      pL: (x0,x1,x2,x3,x4,x5) => x0.drawImage(x1,x2,x3,x4,x5),
