...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      GJ: x0 => x0.image,
      GK: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      GL: (x0,x1) => x0.getItem(x1),
      GM: (x0,x1) => x0.replaceChildren(x1),
      ...
      II: (a, i) => a.splice(i, 1),
      IJ: () => new FileReader(),
      IK: () => new XMLHttpRequest(),
      IL: x0 => x0.nextSibling,
      IM: (x0,x1,x2) => x0.setAttribute(x1,x2),
      ...
      JI: a => a.pop(),
      JJ: (x0,x1) => x0.readAsArrayBuffer(x1),
      JK: (x0,x1) => x0.get(x1),
      JL: (x0,x1) => x0.debug(x1),
      JM: (x0,x1) => { x0.accept = x1 },
      K: (exn) => {
      ...
      MK: (x0,x1) => x0.getRandomValues(x1),
      ML: (x0,x1) => x0.getModifierState(x1),
      MM: (x0,x1,x2,x3) => x0.decrypt(x1,x2,x3),
      N: (c) =>
      ...
      OK: l => new DataView(new ArrayBuffer(l)),
      OL: x0 => x0.altKey,
      OM: x0 => x0.crypto,
      ...
      PK: () => new AbortController(),
      PL: x0 => x0.ctrlKey,
      PM: x0 => x0.isSecureContext,
      ...
      QK: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      ...
      UJ: (x0,x1) => { x0.responseType = x1 },
      UK: (x0,x1) => x0.forEach(x1),
      UL: x0 => x0.userAgent,
      ...
      WK: x0 => x0.statusText,
      WL: (x0,x1) => x0.key(x1),
      WM: (x0,x1) => x0.getRandomValues(x1),
      X: o => [o],
      ...
      XK: x0 => x0.url,
      XL: x0 => x0.length,
      XM: (x0,x1,x2,x3) => x0.encrypt(x1,x2,x3),
      Y: (o0, o1) => [o0, o1],
      YB: (t, s) => t.set(s),
      ...
      YJ: x0 => globalThis.URL.createObjectURL(x0),
      YK: x0 => x0.status,
      ...
      cI: x0 => x0.style,
      cJ: (x0,x1,x2,x3) => x0.putImageData(x1,x2,x3),
      cK: x0 => x0.done,
      cL: (x0,x1) => { x0.id = x1 },
      cM: x0 => x0.read(),
      d: (o, p) => o[p],
      ...
      dI: (x0,x1) => { x0.src = x1 },
      dJ: x0 => x0.arrayBuffer(),
      dK: x0 => x0.cancel(),
      dL: () => globalThis.document,
      dM: x0 => x0.assetBase,
      e: () => globalThis,
      ...
      eJ: (x0,x1) => x0.transferFromImageBitmap(x1),
      eK: x0 => x0.body,
      eL: x0 => globalThis.URL.revokeObjectURL(x0),
      eM: x0 => x0.loader,
      ...
      gJ: x0 => x0.width,
      gK: x0 => x0.signal,
      gL: (x0,x1,x2,x3) => x0.toBlob(x1,x2,x3),
      ...
      hH: x0 => x0.next(),
      hI: (x0,x1) => { x0.src = x1 },
      hJ: x0 => x0.rasterEndMilliseconds,
      hK: x0 => x0.abort(),
      hL: x0 => x0.size,
      i: (l, r) => l === r,
      ...
      iJ: x0 => x0.rasterStartMilliseconds,
      iK: (x0,x1,x2,x3) => x0.replaceState(x1,x2,x3),
      iL: (x0,x1,x2,x3) => x0.drawImage(x1,x2,x3),
      j: x0 => x0.random(),
      ...
      jJ: x0 => x0.imageBitmaps,
      jK: x0 => x0.history,
      jL: (x0,x1,x2,x3,x4,x5) => x0.drawImage(x1,x2,x3,x4,x5),
      k: o => o,
      ...
      nJ: (x0,x1,x2) => new ImageData(x0,x1,x2),
      nK: (x0,x1) => new WebSocket(x0,x1),
      nL: (x0,x1) => { x0.height = x1 },
      ...
      pH: x0 => x0.buffer,
      pI: x0 => x0.URL,
      pJ: (x0,x1) => new OffscreenCanvas(x0,x1),
      pK: x0 => x0.code,
      pL: x0 => x0.height,
      ...
      vI: x0 => x0.frameCount,
      vJ: (x0,x1,x2,x3) => x0.drawImage(x1,x2,x3),
      vK: (x0,x1) => x0.send(x1),
      ...
      xI: x0 => x0.completed,
      xJ: x0 => x0.format,
      xK: (x0,x1) => { x0.binaryType = x1 },
      xL: (x0,x1) => { x0.oncancel = x1 },
      ...
      yI: x0 => x0.ready,
      yJ: x0 => x0.decode(),
      yK: x0 => new BroadcastChannel(x0),
      yL: (x0,x1) => { x0.onchange = x1 },
